...
wui_proc_dir <- file.path(anthro_proc_dir, 'wui')
...
count_ztrax_dir <- file.path(ztrax_dir, 'ztrax_raw_count_1980_2015_1k')
cumsum_ztrax_dir <- file.path(ztrax_dir, 'ztrax_raw_cumsum_1980_2015_1k')

# Monthly stacks
terrain_monthly_dir <- file.path(terrain_dir, 'monthly')
bounds_monthly_dir <- file.path(proc_bounds_dir, 'monthly')
anthro_monthly_proc_dir <- file.path(anthro_proc_dir, 'monthly')
transport_monthly_proc_dir <- file.path(transportation_processed_dir, 'monthly')
...
var_dir <- list(prefix, raw_prefix, us_prefix, ecoregion_prefix, roads_prefix, summary_dir, count_ztrax_dir,
                ...
                anthro_monthly_proc_dir, transport_monthly_proc_dir, wui_proc_dir, wui_proc_dir, cumsum_ztrax_dir)
